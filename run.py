...
def print_help() -> None:
    ...
    print()
    print("用法:")
    print("  python run.py [dev|all|backend|frontend|worker|stop|status|test|check|build|coverage|lint|health|clean|test-backend|test-frontend]")
    print()
    print("示例:")
...
def main() -> int:
    ...
    if command == "test-backend":
        ...
        allowed = {"dev", "backend", "frontend", "worker", "stop", "status", "test", "check", "build", "coverage", "lint", "health", "clean"}
